...
export default class MyCart extends React.Component {
  ...
  addButton(e) {
    ...
    this.setState({
     [itemName.qty] :  this.state[itemName] + 1
        ...
        return (
            <div className="myCart">
                ...
                <div className="myCartContent">
                    ...
                    {this.state.item1 < 1 ? null : <div className="itemListing">
                        ...
                        <div className="productListDetails" >
                            ...
                            <div className="qtySection">
                              ...
                              <button name="item1"  className="qtyMinus" onClick={this.removeButton} >-</button>
                              <input type="number"  value={this.state.item1.qty} max="10" ></input>
                              <button name="item1" className="qtyPlus" onClick={this.addButton} >+</button>
                            </div>
                    ...
                    <div className="itemListing">
                        ...
                        <NavLink to="./product_details" ><h1>Essence Coconut oil Body Lotion</h1></NavLink>
                            ...
                            <div className="qtySection">
                              <span className="QtyCounter">Qty:</span>
                              <button name="item2" className="qtyMinus" onClick={this.removeButton} >-</button>
                              <input type="number" value={this.state.item2.qty} ></input>
                              <button name="item2" className="qtyPlus" onClick={this.addButton} >+</button>
                            </div>
                    ...
                    <div className="itemListing">
                      ...
                      <NavLink to="./product_details" ><h1>Essence Tea tree oil facewash</h1></NavLink>
                            ...
                            <div className="qtySection">
                              <span className="QtyCounter">Qty:</span>
                              <button  name="item3" className="qtyMinus" onClick={this.removeButton}>-</button>
                              <input type="number" value={this.state.item3.qty}></input>
                              <button name="item3" className="qtyPlus" onClick={this.addButton} >+</button>
                            </div>
